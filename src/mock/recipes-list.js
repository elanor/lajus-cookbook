module.exports = [
    ...
    // },
    {
      ...
      image: "brazilian-feijoada-image.png",
      ...
      tips: [
        "Adjust the types and amounts of meats according to your preference. Traditional recipes can include other parts of the pork, such as ribs, feet, and ears, as well as beef cuts.",
    ...
    },
    {
      ...
      image: "classic-margherita-pizza-image.png",
      description:
        "Simple yet classic pizza with a delightful blend of fresh mozzarella and basil.",
      servings: "2-3 people",
      preptime: "15 min",
      cookingTime: "10 min",
      ingredients_desc: [
      ...
      instructions_desc: [
        "Roll out the dough to your desired thickness. Spread tomato sauce evenly, leaving a small border. Distribute slices of mozzarella and basil. Drizzle with olive oil and season. Bake in a preheated oven at 500°F (260°C) for about 10 minutes or until crust is golden and cheese bubbles.",
      ],
      tips: [
        "For best results, use a pizza stone and preheat your oven with the stone inside.",
      ],
    },
    {
      id: 3,
      name: "Thai Green Curry Chicken",
      image: "thai-green-curry-chicken-image.png",
      description:
        "Aromatic and spicy, this Thai curry is made with homemade green curry paste and creamy coconut milk.",
      servings: "4 people",
      preptime: "20 min",
      cookingTime: "30 min",
      ingredients_desc: [
      ...
      instructions_desc: [
        "In a pan, sauté the green curry paste until aromatic.",
    ...
    },
    {
      ...
      image: "vegan-quinoa-salad-image.png",
      description:
        "A hearty and healthy salad packed with colorful vegetables and a tangy vinaigrette.",
      servings: "4 people",
      preptime: "10 min",
      cookingTime: "15 min",
      ingredients_desc: [
      ...
      instructions_desc: [
        "Cook quinoa according to package instructions and let it cool. Combine with vegetables in a large bowl. Whisk together lemon juice, olive oil, salt, and pepper. Pour over the salad and toss to coat.",
      ],
    ...
    },
    {
      ...
      image: "french-onion-soup-image.png",
      description:
        "A rich and comforting soup topped with melted Gruyère cheese and crusty bread.",
      servings: "4 people",
      preptime: "10 min",
      cookingTime: "1 hour",
      ingredients_desc: [
      ...
      tips: [
        "For a vegetarian version, substitute beef broth with a robust vegetable broth.",
      ],
    },
  ];
